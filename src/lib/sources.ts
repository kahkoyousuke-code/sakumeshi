...
export const SOURCES = {
  ...
  protein: {
    label: "たんぱく質",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
    url: "https://kennet.mhlw.go.jp/information/information/dictionary/food/ye-044.html",
  },
  carbohydrate: {
    label: "炭水化物 / 糖質",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
    url: "https://kennet.mhlw.go.jp/information/information/dictionary/food/ye-018.html",
  },
  energyMetabolism: {
    label: "身体活動とエネルギー代謝",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
    url: "https://kennet.mhlw.go.jp/information/information/exercise/s-02-003.html",
  },
  dietaryFiber: {
    label: "食物繊維の必要性と健康",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
    url: "https://kennet.mhlw.go.jp/information/information/food/e-05-001.html",
  },
  gutBacteria: {
    label: "腸内細菌と健康",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
    url: "https://kennet.mhlw.go.jp/information/information/food/e-05-003.html",
  },
  bloodSugar: {
    label: "血糖値",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
  ...
  insulin: {
    label: "インスリン",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
    url: "https://kennet.mhlw.go.jp/information/information/dictionary/metabolic/ym-011.html",
  },
  diabetes: {
    label: "糖尿病",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
    url: "https://kennet.mhlw.go.jp/information/information/dictionary/metabolic/ym-048.html",
  },
  sleepLifestyle: {
    label: "睡眠と生活習慣病との深い関係",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
    url: "https://kennet.mhlw.go.jp/information/information/heart/k-02-008.html",
  },
  goodSleep: {
    label: "快眠と生活習慣",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
  ...
  alcoholAbsorption: {
    label: "アルコールの吸収と分解",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
    url: "https://kennet.mhlw.go.jp/information/information/alcohol/a-02-002.html",
  },
  alcoholEffects: {
    label: "アルコールの作用",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
    url: "https://kennet.mhlw.go.jp/information/information/alcohol/a-02-003.html",
  },
  alcoholGuideline: {
    label: "健康に配慮した飲酒に関するガイドライン",
    publisher: "厚生労働省",
    url: "https://www.mhlw.go.jp/stf/newpage_37908.html",
  },
  nutritionLabel: {
    label: "栄養成分表示の活用",
    publisher: "厚生労働省 健康づくりサポートネット（e-ヘルスネット）",
...
const COLUMN_SOURCE_KEYS: Partial<Record<string, SourceKey[]>> = {
  ...
  "alcohol-diet": ["alcoholGuideline", "alcoholAbsorption", "alcoholEffects"],
