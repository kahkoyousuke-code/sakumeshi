...
const TOC = [
  ...
  { id: "experience", label: "禁止より条件付きのほうが続く" },
  { id: "faq", label: "よくある質問" },
  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            厚生労働省の「健康に配慮した飲酒に関するガイドライン」では、
            <strong>生活習慣病のリスクを高める飲酒量を、1日あたりの平均純アルコール量で男性40g以上・女性20g以上</strong>
            としています。女性は男性より少量で影響を受けやすいとされ、基準も低く設定されています。
          </p>
          <p>
            注意しておきたいのは、ガイドラインが
            <strong>「この量までなら安全」という線を引いているわけではない</strong>
            ことです。がんや高血圧などのリスクは飲む量が増えるほど上がり、少ないほどよいという整理になっています。以下はあくまで
            <strong>自分の飲酒量を把握するための目盛り</strong>
            として使ってください。
          </p>
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            減量中のお酒は「やめる」から入りたくなりますが、付き合いの席で飲まないでいるのはストレスが大きく、
            <strong>反動でかえって飲む量が増える</strong>
            という流れになりやすいやり方です。長く続けることを考えるなら、禁止より条件を決めるほうが現実的です。
          </p>
          <p>
            条件は少ないほど守れます。たとえば次の3つだけに絞ります。
            <strong>①1杯目から蒸留酒系にする ②揚げ物は自分から頼まない ③締めには行かない</strong>
            。飲み会のたびに判断しなくて済むので、飲んだ週でも体重の動きが読みやすくなります。
          </p>
          <p>
            3つのうち数字への影響が大きいのは締めです。お酒の種類を変えるより、
            <strong>飲み終わったあとに1食分を丸ごと上乗せしない</strong>
            ほうが効きます。締めは時間帯も遅く、食べてすぐ寝ることになりやすいので、上乗せ分がそのまま残りやすくなります。
          </p>
        </div>
      </section>
