...
const TOC = [
  ...
  { id: "experience", label: "まとめ飲みより、こまめに分ける" },
  { id: "faq", label: "よくある質問" },
  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            取り入れやすいのは、食事の前にコップ1杯の水を飲んでおくことです。劇的な効果を期待するものではありませんが、
            <strong>食べ始めの勢いを落ち着かせる</strong>
            きっかけとしては手軽です。
          </p>
          <p>
            避けたいのは、1日の目標量を決めて、足りない分を夕方や夜にまとめて飲むやり方です。短時間に大量の水を飲むと体調を崩すことがあります。
