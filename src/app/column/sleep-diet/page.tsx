...
const TOC = [
  ...
  { id: "experience", label: "寝不足の時期に起きやすいこと" },
  { id: "faq", label: "よくある質問" },
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <p>
          ...
          。食事を管理しているのに体重が動かないなら、食事の中身より先に睡眠時間を見直す価値があります。
        </p>
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            仕事が立て込んで睡眠が削られる時期は、食事を管理しているつもりでも体重が動きにくくなります。計算の上では赤字が出ているはずなのに落ちない場合、まず疑いたいのは
            <strong>夕方以降の間食が増えていないか</strong>
            です。「今日は疲れたから」が、気づけば毎日になっていることがあります。
          </p>
          <p>
            もうひとつが、選ぶものの変化です。同じ空腹でも、寝不足のときは甘いものや脂質の多いものに手が伸びやすくなります。
            <strong>意志で抑えようとしても、判断そのものが寝不足の影響を受ける</strong>
            ので、気合いで乗り切るのは分が悪い戦い方です。
          </p>
          <p>
            寝られない時期が続くなら、
            <strong>無理に減らそうとせず、維持でしのぐ</strong>
            という選択肢があります。睡眠が戻ってから落とすほうが、崩れて取り返すより結果的に早く進むことが多いはずです。
          </p>
        </div>
      </section>
