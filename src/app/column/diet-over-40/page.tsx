  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            最初にやったのは運動ではなく食事でした。最初の1〜3ヶ月は運動をしておらず、それで
            <strong>3〜5kg落ちています</strong>
            。ただし当時は記録をほとんど取っていなかったので、この数字は概数です。
          </p>
          <p>
            効いたのがタンパク質です。当時は
            <strong>1日50gしか摂れていませんでした</strong>
            。計算して出てくる目標量の半分にも届いていません。ここを増やしたら、同じカロリーでも空腹が明らかに楽になりました。体重の落ち方より、
            <strong>続けやすさが変わった</strong>という感覚です。
          </p>
          <p>
            逆に、体重が落ちても見た目はしばらく変わりませんでした。92kgに対する3〜5kgは約3〜5%なので、鏡で分かるほどの差にはなりません。筋トレを足して形が変わったと感じるまでには、そこから半年以上かかっています（
            <a
          ...
          <p>
            年齢が上がるほど効いてくるのは、完璧さより週単位の帳尻です。1日崩れただけでリセット扱いにすると、そこで終わります。
            <strong>完璧を目指した瞬間に破綻します</strong>。
          </p>
          <p>
            数字を出す、タンパク質を確保する、週単位で管理する——やったのはこの3つです。特別な方法は使っていません。
          </p>
        </div>
      </section>
