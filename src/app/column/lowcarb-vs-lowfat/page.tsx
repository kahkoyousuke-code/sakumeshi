  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <article>
        ...
        <div className="space-y-10 text-gray-700 leading-relaxed text-[15px]">
          ...
          <section>
            ...
            <div className="space-y-5">
              ...
              <p>
                低脂質は、ごはんを主食として残せるのが大きい方法です。主食を抜かずに済むぶん、外食も家族との食事も通常どおり回せます。
                <strong>制限している感覚が薄いほど、続く期間は長くなります</strong>
                。
              </p>
            </div>
          </section>
        ...
        <ColumnFooter slug="lowcarb-vs-lowfat" ctaLabel="サクメシで食事プランを作る →" />
      </article>
    </div>
  );
}
