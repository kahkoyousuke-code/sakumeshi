...
const TOC = [
  ...
  { id: "experience", label: "1日50gだった頃から変えたこと" },
  { id: "faq", label: "よくある質問" },
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <p>
          ダイエットの相談を受けると、タンパク質が足りていない人がとても多いです。自分も92kgから減量を始めた頃は、1日50gも摂れていませんでした。ここを意識してから、
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            92kgから減量を始めた当初、
            <strong>1日のタンパク質は50g前後しかありませんでした</strong>
            。朝はトーストとコーヒー、昼はうどんかパスタの単品、夜だけまともに肉を食べる。これで足りているつもりでいました。
          </p>
          <p>
            変えたのは2か所です。まず朝を卵と納豆に。次に昼の単品をやめて、サラダチキンかゆで卵を足すようにしました。
            <strong>朝と昼、2か所の中身を入れ替えただけ</strong>
            です。
          </p>
          <p>
            はっきり変わったのは
            <strong>夕方の空腹</strong>
            です。同じカロリーでも、夕方に何か食べたくなる感じが明らかに弱くなりました。
          </p>
          <p>
            これから増やす人は、上の「無理なく増やすコツ」のとおり、一気にではなく少しずつ進めてください。肉や卵に寄せると野菜が減りやすいので、
