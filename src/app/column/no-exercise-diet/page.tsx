...
const TOC = [
  ...
  { id: "experience", label: "運動ゼロだった最初の数ヶ月で落ちた分" },
  { id: "faq", label: "よくある質問" },
  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            92kgから落とし始めた最初の1〜3ヶ月、自分は運動をしていませんでした。ジムにも行っていないし、走ってもいない。それでも
            <strong>3〜5kg落ちています</strong>
            。この記事に書いた「食事だけでも体重は動く」は、自分の場合はそのとおりでした。
          </p>
          <p>
            ただし、落ちた量を開始時の体重で割ると
            <strong>約3〜5%</strong>
            です。体重計の数字は動いていても、見た目はほとんど変わりませんでした。そのあと筋トレ（週2回）を足しましたが、形が変わったと感じるまでには
            <strong>さらに半年以上</strong>かかっています。
          </p>
          <p>
            <strong>体重を落とすのは食事、形を作るのは運動</strong>
            ——役割が違うというのが、両方やってみた結論です。この順番と、それぞれにかかった時間は
            <a
            ...
            に詳しく書きました。なお当時は記録をほとんど取っていなかったので、ここの数字はすべて概数です。
          </p>
        </div>
      </section>
