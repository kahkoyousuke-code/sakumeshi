      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            ...
            。それだけです。食事を派手に変えたつもりはないのに、数ヶ月後には元の位置に戻っていました。
          </p>
          <p>
            あとから振り返ると、原因は「戻した量」ではなく「見なくなったこと」でした。体重を量らない期間が続くと、少し増えた段階では気づけません。気づいたときにはまとまった量が戻っていて、そこからまた一からやり直しになります。
          </p>
          <p>
          ...
          <p>
            上で書いた+2kgラインも、同じ理由で役に立ちます。数字を先に決めておくと、超えたときに「どうしよう」と悩まずに済み、悩む時間がないぶん動き出しが早くなります。
          </p>
        </div>
      </section>
